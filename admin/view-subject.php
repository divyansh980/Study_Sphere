...
$sql = "SELECT * FROM subject"; // Fetching id along with questions
		  ...
		  <div class="row">
			...
			<div class="col-12">
				<div class="box">
					...
					<!--</div>-->
					<div class="box-body">
					    <a type="button" class="btn btn-primary" href="add-subject.php">Add Subject</a>
						   	...
						   	<table id="example" class="display table table-striped table-bordered display" style="width:100%">
								...
								<tbody>
								    ...
								    <tr data-id="'.$row['id'].'">
								            ...
								            <td><img class="me-2" src="ajax/images/'.$row['subjectimage'].'" width="100px">'.$row['subject'].'</td>
                                            <td class="text-center"><a type="button" href="edit-subject.php?updateid='.$row['id'].'" class="btn btn-primary">Edit</a></td>
