		  ...
		  <div class="row">
			...
			<div class="col-12">
				<div class="box">
					...
					<!--</div>-->
					<div class="box-body">
					    <a type="button" href="add-courses.php" class="btn btn-primary">Add Courses</a>
						<div class="table-responsive">
						   	<table id="example" class="display table table-striped table-bordered display" style="width:100%">
								...
								<tbody>
								    ...
								    <tr data-id="'.$row['id'].'">
								            <td>'.$row['id'].'</td>
								            <td><img class="me-2" src="ajax/images/'.$row['courseimage'].'" width="100px">'.$row['courses'].'</td>
								            <td class="text-center"><a type="button" href="edit-course.php?updateid='.$row['id'].'" class="btn btn-primary">Edit Course</a></td>
                                            <td class="text-center"><button class="btn btn-warning delete-btn" href="delete-course.php">Delete Course</a></td>
                                        </tr>
