...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $bookImageResult = handleFileUpload('newbookimage', $_POST['oldbookimage'], $uploadDir);
    ...
    // Update query
    $sql = "UPDATE books SET class = ?, subject = ? , book = ?, bookimage = ? WHERE id = ?";

    // Prepare the statement
    if ($stmt = $conn->prepare($sql)) {
        // Bind parameters
        $stmt->bind_param("ssssi", $class, $subject, $book, $bookImageResult['fileName'], $id); // Correct binding
