							   ...
							   <ul style="line-height: 30px;">
							    <?php if (!empty($lessonsArray)): ?>
                                    <?php foreach ($lessonsArray as $lesson): ?>
                                        <li>
                                            <a href="preview-book.php?class=<?php echo $_GET['class']; ?>&book=<?php echo urlencode($_GET['book']); ?>&subject=<?php echo urlencode($_GET['subject']); ?>&lesson=<?php echo urlencode($lesson); ?>">
