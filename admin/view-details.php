...
$sql = "SELECT * FROM adddetails"; // Fetching id along with questions
...
<head>
    ...
    <title>Fields For Question</title>
					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Fields For Question</li>
							</ol>
						</nav>
					</div>
				</div>
		  ...
		  <div class="row">
			...
			<div class="col-12">
				<div class="box">
					...
					<!--</div>-->
					<div class="box-body">
					    <a type="button" class="btn btn-primary" href="add-other-details.php">Add Fields</a>
						   	...
						   	<table id="example" class="display table table-striped table-bordered display" style="width:100%">
								...
								<tbody>
								    ...
								    <tr data-id="'.$row['id'].'">
                                            ...
                                            <td>'.$row['lesson'].'</td>
                                            <td>'.$row['topic'].'</td>
                                            <td class="text-center"><a type="button" href="edit-question-detail.php?updateid='.$row['id'].'" class="btn btn-primary">Edit</a></td>
                                            <td class="text-center"><button class="btn btn-warning delete-btn" href="delete-question.php">Delete</a></td>
                                    </tr>
