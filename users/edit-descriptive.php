...
$sql = "SELECT * FROM descriptive WHERE id='$updateid'"; // Fetching id along with questions
...
<head>
    ...
    <title>Edit Descriptive Questions</title>
        ...
        <div class="container-full">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title">Edit Descriptive Questions</h4>  
                            </div>
                            <div class="box-body">
					...
					<!--	<div>-->
					<!--		<input placeholder="0" step="0.01" value=""  min="0" class="form-control" type="number" name="negative">-->
					<!--	</div>-->
					<!--</div>-->
					<div id="questionsContainer">
                            ...
                            for ($index = 0; $index < $totalQuestions; $index++) {
                                ...
                                echo '<div class="">';
                                echo '<textarea class="form-control tinymce-answer" type="text" name="answer[]">' . htmlspecialchars($answersArray[$index]) . '</textarea>';
                                echo '</div>';
                                echo '</div>';
...
<script>
 ...
 <script>
    ...
    $('#edit-questions').on('submit', function(event) {
        ...
        $.ajax({
            url: 'ajax/edit-descriptive.php', // The PHP script to handle the insertion
            type: 'POST',
            ...
            success: function(response) {
                ...
                window.location.href = 'view-descriptivequestions.php';
            },
