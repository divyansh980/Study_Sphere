...
$sql = "SELECT * FROM addbook WHERE id='$updateid'"; // Fetching id along with books
...
$booksArray = json_decode($row['books'], true);
...
<div class="wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title">Edit the Book</h4>  
                            </div>
                            <div class="box-body">
					...
					<div class="form-group col-md-4">
						...
						<div>
							<select class="form-control" name="topic" required>
							    <option selected value="<?php echo $row['topic'];?>"><?php echo $row['topic'];?>(Selected)</option>
				    ...
				    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row['serial'];?>" name="serial">
                    </div>
    ...
    <?php if (!empty($booksArray)): ?>
        <?php foreach ($booksArray as $index => $books): ?>
            <div class="books">
                <div class="form-group row">
                    <div class="col-md-12">
                        <textarea class="form-control" type="text" name="books[]"><?php echo htmlspecialchars($books); ?></textarea>
                    </div>
...
$(document).ready(function() {
 ...
 <script>
    ...
    $('#edit-book').on('submit', function(event) {
        ...
        $.ajax({
            url: 'ajax/editbook.php', // The PHP script to handle the insertion
            type: 'POST',
