					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Descriptive</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<div class="box">
					...
					<div class="box-body">
					    <form id="myForm" class="row">
					        ...
					        <input type="hidden" value="Descriptive" name="questiontype" id="questiontype">
					...
					<div class="form-group col-md-3 mt-2">
						<label></label>
						<div>
							 <a href="add-descriptivequestions.php" class="btn btn-primary" type="button">Add Descriptive</a>
						</div>
					</div>
                ...
                data.questions.forEach(function(questionObj) {
                    ...
                    if (questionArray.length > 0) {
                        ...
                        questionsHtml += '<div>' +
                            ...
                            '<a href="edit-descriptive.php?updateid='+ questionObj.id +'" class=" btn btn-primary me-2" type="button" data-id="' + questionObj.id + '">Edit</a>' +
...
$(document).ready(function() {
    $('#response').on('click', '.delete-btn', function() {
        ...
        if (confirm('Are you sure you want to delete this question?')) {
            $.ajax({
                url: 'ajax/delete-descriptive.php',
                type: 'POST',
                data: { id: id },
