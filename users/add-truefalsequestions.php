			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-header">
					<h4 class="box-title">Enter True and False Questions</h4>  
				</div>
				<div class="box-body">
                                            ...
                                            <div class="question-block row">
                                               <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-12">Enter Your Answer</label>
...
<script>
    ...
    $('#insert-questions').on('submit', function(event) {
        ...
        $.ajax({
            url: 'ajax/add-truefalse.php', // The URL to which the request is sent
