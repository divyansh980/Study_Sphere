			  ...
			  <div class="box">
				...
				<div class="box-body">
				    ...
				    <div class="form-group col-md-2">
						...
						<div>
						    <input placeholder="1" min="1" class="form-control" type="number" value="1" name="marks" required>
						</div>
					</div>
					<div class="form-group col-md-2">
					...
					<div class="form-group col-md-2">
						...
						<div>
							<input placeholder="0"  value="0" step="0.01" min="0" class="form-control" type="number" name="negative" required >
						</div>
					</div>
                                            ...
                                            <div class="question-block row">
                                               <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <div>
                                                        <input class="form-control option-input" required type="text" name="questions[]" value="Both Assertion(A) and Reason(R) are true and R is the correct explanation of A." oninput="updateCheckboxValue(this, 'checkbox1')" data-question="1" data-option="1" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <div>
                                                        <input class="form-control option-input" required type="text" name="questions[]" value="Both Assertion(A) and Reason(R) are true but R is not the correct explanation of A." oninput="updateCheckboxValue(this, 'checkbox2')" data-question="2" data-option="2" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-1">
                                                    <label class="col-form-label"></label>
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <div>
                                                        <input class="form-control option-input" required type="text" name="questions[]" value="Assertion(A) is true but Reason(R) is false."  oninput="updateCheckboxValue(this, 'checkbox3')" data-question="3" data-option="3" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-1">
                                                    <label class="col-form-label"></label>
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <div>
                                                        <input class="form-control option-input" required type="text" name="questions[]" value="Assertion(A) is false but Reason(R) is true." oninput="updateCheckboxValue(this, 'checkbox4')" data-question="4" data-option="4" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-1">
                                                    <label class="col-form-label"></label>
...
<script>
    ...
    $('#insert-questions').on('submit', function(event) {
        ...
        $.ajax({
            url: 'ajax/add-arbased.php', // The URL to which the request is sent
