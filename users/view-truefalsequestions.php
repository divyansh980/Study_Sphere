				...
				<div class="box">
					...
					<div class="box-body">
					    <form id="myForm" class="row">
					        ...
					        <input type="hidden" value="True/False" name="questiontype" id="questiontype">
					...
					<div class="form-group col-md-3 mt-2">
						<label></label>
						<div>
							 <a href="add-truefalsequestions.php" class="btn btn-primary" type="button">Add True/False</a>
						</div>
					</div>
                ...
                data.questions.forEach(function(questionObj) {
                    ...
                    if (questionArray.length > 0) {
                        ...
                        questionsHtml += '<div>' +
                            ...
                            '<a href="edit-truefalse.php?updateid='+ questionObj.id +'" class=" btn btn-primary me-2" type="button" data-id="' + questionObj.id + '">Edit</a>' +
