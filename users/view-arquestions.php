					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">AR Based</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<div class="box">
					...
					<div class="box-body">
					    <form id="myForm" class="row">
					        ...
					        <input type="hidden" value="AR Based" name="questiontype" id="questiontype">
					...
					<div class="form-group col-md-3 mt-2">
						<label></label>
						<div>
							 <a href="add-arquestions.php" class="btn btn-primary" type="button">Add AR Based</a>
						</div>
					</div>
                ...
                data.questions.forEach(function(questionObj) {
                    ...
                    if (questionArray.length > 0) {
                        ...
                        questionsHtml += '<div>' +
                            ...
                            '<a href="edit-arbased.php?updateid='+ questionObj.id +'" class=" btn btn-primary me-2" type="button" data-id="' + questionObj.id + '">Edit</a>' +
