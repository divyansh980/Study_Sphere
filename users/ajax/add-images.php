...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $uploadDir = '../../ajax/images/'; // Make sure this directory exists and is writable
    ...
    // Upload images
    $imageResult = handleFileUpload($image, $uploadDir);
    ...
    $stmt = $conn->prepare("INSERT INTO contentimage (user_id, image) VALUES (?, ?)");
    ...
    // Bind the parameters
    $stmt->bind_param("ss", $userid, $imageResult['fileName']);
