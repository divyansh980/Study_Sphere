...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO descriptive (user_id, class, subject, book, lesson, question, answer, marks, difficulty, solution) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

    // Bind parameters
    $stmt->bind_param("sssssssiis", $userId, $class, $subject, $book, $lesson, $questionsJson, $answersJson, $marks, $difficulty, $solutionsJson);
