...
$sql = "SELECT * FROM truefalse WHERE id='$updateid'"; // Fetching id along with questions
...
<head>
    ...
    <title>Edit True/False Questions</title>
...
<div class="wrapper">
                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title">Edit True/False Questions</h4>  
                            </div>
                            <div class="box-body">
    ...
    if ($index === 0) {
        ...
        echo '<label class="col-form-label col-md-12">Enter Your Answer</label>';
        echo '<div class="col-md-6">';
        echo '<input type="radio" id="true' . $answer . '" name="answer' . $answer . '" value="true" ' . ($answer== 'true' ? 'checked' : '') . '>';
        echo '<label for="true' . $answer . '">True</label>';
        echo '</div>';
        echo '<div class="col-md-6">';
        echo '<input type="radio" id="false' . $answer . '" name="answer' . $answer . '" value="false" ' . ($answer == 'false' ? 'checked' : '') . '>';
        echo '<label for="false' . $answer . '">False</label>';
        echo '</div>';
        echo '</div>';
    }
...
$(document).ready(function() {
    $('#edit-questions').on('submit', function(event) {
        ...
        $.ajax({
            url: 'ajax/edit-truefalse.php', // The PHP script to handle the insertion
            type: 'POST',
            ...
            success: function(response) {
                ...
                window.location.href = 'view-truefalsequestions.php';
            },
