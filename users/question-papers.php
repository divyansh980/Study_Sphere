...
$sql = "
SELECT DISTINCT class, subject, book, papertitle FROM questionpaper WHERE user_id = '$userid' 
";
			...
			<section class="content">
				<div class="row">
					<div class="col-12">
						<div class="box">
							<div class="box-body">
							    <a href="add-questionpaper.php" class="btn btn-primary" type="button">Add Questions Paper</a>
								    ...
								    <table id="example" class="display table table-striped table-bordered display" style="width:100%">
										...
										<tbody>
										    ...
										    while ($row = $result->fetch_assoc()) {
                                                echo '
                                                <tr data-id="'.$row['papertitle'].'">
                                                    <td>'.$row['class'].'</td>
                                                    <td>'.$row['subject'].'</td>
                                                    <td>'.$row['book'].'</td>
                                                    <td>'.$row['papertitle'].'</td>
                                                    <td class="text-center"><a class="btn btn-primary" href="question-paper.php?book='.$row['book'].'& class='.$row['class'].'& subject='.$row['subject'].'&papertitle='.$row['papertitle'].'">View</a></td>
